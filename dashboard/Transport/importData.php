...
if(isset($_POST['importSubmit'])){
    ...
    if(!empty($_FILES['file']['name']) && in_array($_FILES['file']['type'],$csvMimes)){
        if(is_uploaded_file($_FILES['file']['tmp_name'])){
            ...
            //skip first line
            fgetcsv($csvFile);
            $DELETE ="DELETE FROM [WebDashboard].[dbo].[PDTNumber3G] ";
            ...
            $INSERT ="INSERT INTO [WebDashboard].[dbo].[PDTNumber3G]  VALUES ('$PDTNumber','$G','$Cluster','$Kab','$Long','$Lat')";
...
header("Location: 3GPDTNumber.php");