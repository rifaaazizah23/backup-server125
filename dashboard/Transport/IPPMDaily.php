...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="title_left">
			<h3>Transport IPPM <small>3G Daily</small></h3>
		</div>
	</div>
<!-- Menu Bar -->
							...
							<div class="control-group">
								<div class="controls">
									<div class="col-md-12 xdisplay_inputx form-group has-feedback">
										<input type="text" class="form-control has-feedback-left" id="single_cal1" name="tanggal" placeholder="Select Date" aria-describedby="inputSuccess2Status">
...
<div class="row">
							...
							<div class="row">
								<div class="clearfix"></div>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="x_panel">
											<div class="x_title">
												<h2><i class="fa fa-bars"></i> CENTRAL <?php $tanggal = $_POST['tanggal']; echo $tanggal ; ?></h2>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="x_panel">
										<div class="x_title">
											<h2><i class="fa fa-bars"></i> JABODETABEK <?php echo $tanggal ; ?></h2>
												<ul class="nav navbar-right panel_toolbox">
													<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
												</ul>
												<div class="clearfix"></div>
							...
							<div class="row">
								<div class="clearfix"></div>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="x_panel">
											<div class="x_title">
												<h2><i class="fa fa-bars"></i> EAST <?php echo $tanggal; ?></h2>
												<ul class="nav navbar-right panel_toolbox">
													<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
												</ul>
												<div class="clearfix"></div>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="x_panel">
										<div class="x_title">
											<h2><i class="fa fa-bars"></i> WEST <?php echo $tanggal ; ?></h2>
												<ul class="nav navbar-right panel_toolbox">
													<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
												</ul>
												<div class="clearfix"></div>
							...
							<div class="row">
								<div class="clearfix"></div>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="x_panel">
											<div class="x_title">
												<h2><i class="fa fa-bars"></i> NORTH <?php echo $tanggal; ?></h2>
												<ul class="nav navbar-right panel_toolbox">
													<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
												</ul>
												<div class="clearfix"></div>
										...
										<table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
											<thead>
												<tr>
													...
													<th class="text-center">Bad_Remark</th>
													<th class="text-center">IUB_perf</th>
												</tr>
											</thead>
												<tbody>
													<?php
														$tgl	= $_POST['tanggal'];
														$SQL	= "SELECT * FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [DateId]='$tgl'";
																	...
																	while($data = sqlsrv_fetch_array($result))
																		{
																			echo	'<tr>
																						...
																						<th class="text-center">'.$data['Bad_Remark'].'</th>
																						<th class="text-center">'.$data['IUB_perf'].'</th>
																					</tr>'
																		;}
													?>
												</tbody>
 ...
 <?php
	...
	$Central_SQL_Loss_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'OK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Loss_NOT 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'NOK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Delay_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'OK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Delay_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'NOK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Rejection_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'OK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Rejection_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'NOK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Jitter_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'OK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_Jitter_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'NOK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_SctpRetrans_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'OK' AND [Region] ='CENTRAL' ";
	...
	$Central_SQL_SctpRetrans_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'NOK' AND [Region] ='CENTRAL' ";
	...
	// GET Loss_Remark OK
	$Jabo_SQL_Loss_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'OK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Loss_NOT 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'NOK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Delay_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'OK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Delay_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'NOK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Rejection_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'OK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Rejection_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'NOK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Jitter_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'OK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_Jitter_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'NOK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_SctpRetrans_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'OK' AND [Region] ='JABODETABEK' ";
	...
	$Jabo_SQL_SctpRetrans_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'NOK' AND [Region] ='JABODETABEK' ";
	...
	// GET Loss_Remark OK
	$East_SQL_Loss_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'OK' AND [Region] ='EAST' ";
	...
	$East_SQL_Loss_NOT 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'NOK' AND [Region] ='EAST' ";
	...
	$East_SQL_Delay_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'OK' AND [Region] ='EAST' ";
	...
	$East_SQL_Delay_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'NOK' AND [Region] ='EAST' ";
	...
	$East_SQL_Rejection_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'OK' AND [Region] ='EAST' ";
	...
	$East_SQL_Rejection_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'NOK' AND [Region] ='EAST' ";
	...
	$East_SQL_Jitter_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'OK' AND [Region] ='EAST' ";
	...
	$East_SQL_Jitter_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'NOK' AND [Region] ='EAST' ";
	...
	$East_SQL_SctpRetrans_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'OK' AND [Region] ='EAST' ";
	...
	$East_SQL_SctpRetrans_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'NOK' AND [Region] ='EAST' ";
	...
	// GET Loss_Remark OK
	$West_SQL_Loss_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'OK' AND [Region] ='WEST' ";
	...
	$West_SQL_Loss_NOT 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'NOK' AND [Region] ='WEST' ";
	...
	$West_SQL_Delay_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'OK' AND [Region] ='WEST' ";
	...
	$West_SQL_Delay_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'NOK' AND [Region] ='WEST' ";
	...
	$West_SQL_Rejection_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'OK' AND [Region] ='WEST' ";
	...
	$West_SQL_Rejection_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'NOK' AND [Region] ='WEST' ";
	...
	$West_SQL_Jitter_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'OK' AND [Region] ='WEST' ";
	...
	$West_SQL_Jitter_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'NOK' AND [Region] ='WEST' ";
	...
	$West_SQL_SctpRetrans_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'OK' AND [Region] ='WEST' ";
	...
	$West_SQL_SctpRetrans_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'NOK' AND [Region] ='WEST' ";
	...
	// GET Loss_Remark OK
	$North_SQL_Loss_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'OK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Loss_NOT 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Loss_Remark] = 'NOK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Delay_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'OK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Delay_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Delay_Remark] = 'NOK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Rejection_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'OK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Rejection_NOT 	= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Rejection_Remark] = 'NOK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Jitter_OK 	= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'OK' AND [Region] ='NORTH' ";
	...
	$North_SQL_Jitter_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [Jitter_Remark] = 'NOK' AND [Region] ='NORTH' ";
	...
	$North_SQL_SctpRetrans_OK 		= "SELECT count([System]) as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'OK' AND [Region] ='NORTH' ";
	...
	$North_SQL_SctpRetrans_NOT 		= "SELECT count([System])as jumlah FROM [10.17.6.69].[MTransmisi].[dbo].[VMIubPerfDayRemark] WHERE [Dateid] = '$tanggal' AND [SctpRetrans_Remark] = 'NOK' AND [Region] ='NORTH' ";
