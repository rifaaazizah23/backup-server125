...
<script type="text/javascript">
      ...
      function getUsers() {
        $.getJSON("get3G.php", function (data) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].PDTNumber.length > 1) {
              var title = "<div style='font-size: 12px; color: #000000;'>PDTNumber : "+ data[i].PDTNumber + "</a><br>3G : "+data[i].Site + "<br>Cluster : "+data[i].Cluster + "<br>Kabupaten : "+data[i].Kab + "</div>";
            }
            else {
