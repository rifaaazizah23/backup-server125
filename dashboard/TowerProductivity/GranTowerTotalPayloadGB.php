...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="title_left">
			<h3>Tower Productivity<small>Gran Tower Total PayloadGB</small></h3>
		</div>
	</div>
	<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>2G Tower Total PayloadGB</h2>
                  ...
                  <div class="x_content">
					<div id="erlang2" class="demo-placeholder"></div>
                  </div>
                </div>
         </div>
	</div>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                              ...
                              WHERE [Resource]='GranTowerTotalPayloadGB' order by [Week] asc";
...
<script>
      ...
      function drawChart() {
        ...
        var options = {
          title: '2G Tower Total PayloadGB',
		  pointSize: 4,
          curveType: 'function',
        ...
        var chart = new google.visualization.LineChart(document.getElementById('erlang2'));
