<script type="text/javascript">
      ...
      function getUsers() {
        $.getJSON("get_dspall.php", function (data) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].name.length > 1) {
              var title = "<div style='font-size: 12px; color: #000000;'>Bsc Id / Rnc Id : <a href='detailDSP.php?rnc="+ data[i].name +"' target='_blank'>"+ data[i].name + "</a><br>VsDspLoadMean : "+data[i].VsDspLoadMean + "</div>";
            }
            else {
