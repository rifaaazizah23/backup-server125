...
from [10.23.32.165].[MUtranRncCapacity].[dbo].[MRncTrafficHour]
where dateid ='$day1' and [RNC] = '$rnc'
group by [RNC],dateid,hourid
order by [RNC],dateid desc,hourid
 ";
