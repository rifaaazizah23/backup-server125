      ...
      <!-- MULAI DARI SINI -->
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
				  <p>Congest = <img src="towerHigh.png" style="width:20px ; height : 20px">|
					Not Congest = <img src="towerMedium.png" style="width:20px ; height : 20px">|
...
<script type="text/javascript">
      ...
      function getUsers() {
        $.getJSON("get_3gcongestion.php", function (data) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].name.length > 1) {
              var title = "<div style='font-size: 12px; color: #000000;'>Site Id : <a href='Detail3G.php?SiteId="+ data[i].name +"' target='_blank'>"+ data[i].name + "</a><br>SiteName : "+data[i].SiteName + "<br>Rnc : "+data[i].Rnc + "<br>HourId : "+data[i].HourId + "<br>CellAvailabilitySYS : "+data[i].CellAvailabilitySYS + "<br>CodeUtilization : "+data[i].CodeUtilization + "<br>PowerUtilization : "+data[i].PowerUtilization + "<br>HsUserUtilization : "+data[i].HsUserUtilization + "<br></div>";
            }
            else {
