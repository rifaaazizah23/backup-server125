<script type="text/javascript">
      ...
      function getUsers() {
        $.getJSON("get_rnc.php", function (data) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].name.length > 1) {
              var title = "<div style='font-size: 12px; color: #000000;'>Bsc Id / Rnc Id : <a href='detail.php?rnc="+ data[i].name +"' target='_blank'>"+ data[i].name + "</a><br> MP Load Rate : "+data[i].load+"<br> Remark MP Load: "+data[i].remark+"</div>";
            }
            else {
