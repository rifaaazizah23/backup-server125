...
<script type="text/javascript">
      ...
      function getUsers() {
        $.getJSON("get_towerinfo.php", function (data) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].name.length > 1) {
              var title = "<div style='font-size: 12px; color: #000000;'>Tower Id : "+ data[i].name + "</a><br>Site Id : "+ data[i].SITEID + "</a><br>Site Name : "+ data[i].SITENAME + "</a><br>BSC : "+ data[i].BSC + "</a><br>BTS TYPE : "+ data[i].BTS_TYPE + "</a><br>SITE LAYER : "+ data[i].SITE_LAYER + "</a><br>LongLat : "+data[i].lng + ","+data[i].lat +"<br></div>";
            }
            else {
