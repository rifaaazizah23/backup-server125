<script type="text/javascript">
      ...
      function getUsers() {
        $.getJSON("get_psall.php", function (data) {
          for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].name.length > 1) {
              var title = "<div style='font-size: 12px; color: #000000;'>Bsc Id / Rnc Id : <a href='detailPS.php?rnc="+ data[i].name +"' target='_blank'>"+ data[i].name + "</a><br>ThpCapMbps : "+data[i].ThpCapMbps + "<br>Throughput : "+data[i].Throughput + "<br>Utilization : "+data[i].Utilization + "</div>";
            }
            else {
